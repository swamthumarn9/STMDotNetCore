...
namespace STMDotNetCore.ConsoleAppRefitExample
{
    ...
    {
        private readonly IBlogApi _service = RestService.For<IBlogApi>("https://localhost:7285");
        public async Task RunAsync()
        {
            //await ReadAsync();
            await EditAsync(1);
            await EditAsync(100);
            await CreateAsync("Food","June","FoodBlog");
            await UpdateAsync(15, "Play", "Sem", "Football");
